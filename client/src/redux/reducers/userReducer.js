...
export const userReducer = (state = { user: {} }, { type, payload }) => {
    ...
    switch (type) {
        ...
        case UPDATE_USER_SCORE:
            return {
                ...state,user:{...state.user,score:payload }
            };
